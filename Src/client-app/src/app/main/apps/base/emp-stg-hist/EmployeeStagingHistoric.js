...
import EmployeeStagingHistoricHeader from './EmployeeStagingHistoricHeader';
...
function EmployeeStagingHistoric(props) {
  const dispatch = useDispatch();  
  const employeeStagingHistorics = useSelector((store) => store.employeeStagingHistorics);
  const employeeStagingHistoricErrors = useSelector((store) => store.employeeStagingHistoricErrors);
  ...
  async function handleCloseModal()
  {
    ...
    useEffect(() => {
      //dispatch(getEmployeeStagingHistorics());
  }, [dispatch]);
  ...
  return (
    <Root header={<EmployeeStagingHistoricHeader />} content={
      <>
                  ...
                  <PageCarded
                      ...
                      <>
                          <Grid
                              ...
                              data={employeeStagingHistorics?.slice(page.skip, page.take + page.skip)}
                              sortable={true}
                              skip={page.skip}
                              take={page.take}
                              total={employeeStagingHistorics?.length}
                              pageable={true}
                              pageSize={8}
                            ...
                            <Box sx={style}>
                                ...
                                <div>
                                    <Grid
                                        ...
                                        data={employeeStagingHistoricErrors}
                                        >
...
export default EmployeeStagingHistoric;

...
const interfaceExecutionSlice = createSlice({
    ...
    initialState: { id: 1, interface: 'SF OnDemand', status: 'Completed', startedBy: 'gborjas', startedOn: '2022/01/01 13:20:20', finishedOn: '2022/01/01 13:22:20', processed: 15, succeded: 15, failed: 0 },
    reducers: {},
    extraReducers: {

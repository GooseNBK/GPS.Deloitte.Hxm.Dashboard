...
function UpstreamVsDownstreamWidgets(props) {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-42 sm:gap-48">
          <div className="flex flex-col">
            <div className="flex items-center">
              <div className="font-medium text-secondary leading-5">Interfaces</div>
              <Tooltip title="Number of times that an interface was executed in the last 30 days.">
                <SvgIcon className="ml-6" size={16} color="disabled">
            ...
            <div className="flex items-start mt-8">
              ...
              <div className="flex items-center ml-8">
                <SvgIcon className="text-green-500" size={20}>
          ...
          <div className="flex flex-col">
            <div className="flex items-center">
              <div className="font-medium text-secondary leading-5">Upstream</div>
              <Tooltip title="Percent of records processed by the upstream integrations compared to the previous 30 days.">
                <SvgIcon className="ml-6" size={16} color="disabled">
                  heroicons-solid:arrow-circle-up
                </SvgIcon>
              </Tooltip>
            ...
            <div className="flex items-start mt-8">
              ...
              <div className="flex items-center ml-8">
                <SvgIcon className="text-red-500" size={20}>
          ...
          <div className="flex flex-col">
            <div className="flex items-center">
              <div className="font-medium text-secondary leading-5">Downstream</div>
              <Tooltip title="Percent of records processed by the downstream integrations compared to the previous 30 days.">
                <SvgIcon className="ml-6" size={16} color="disabled">
                  heroicons-solid:information-circle
                </SvgIcon>
              </Tooltip>
...
export default UpstreamVsDownstreamWidgets;
